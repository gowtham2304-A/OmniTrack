            ...
            >
                <div className="glass-card p-8 bg-gray-900/50 relative overflow-hidden">
                    ...
                    <div className="mt-8 relative flex items-center justify-center">
                        <div className="absolute w-full border-t border-gray-700/50" />
                        <span className="relative bg-gray-900 px-4 text-gray-400 text-xs font-medium z-10 rounded-full border border-gray-700/50">
                            Or continue with
                        </span>
                    </div>

                    <div className="grid grid-cols-2 gap-3 mt-6">
                        <button className="flex items-center justify-center gap-2 py-3 bg-gray-800/50 border border-gray-700/50 hover:bg-gray-700/50 transition-colors rounded-xl text-sm font-medium text-gray-300 hover:text-white">
                    ...
                    <p className="mt-8 text-center text-xs text-gray-500">
                        Don't have an account? <a href="#" className="font-medium text-purple-400 hover:text-white transition-colors">Sign up securely</a>
                    </p>
                </div>
            </motion.div>
        </div>
